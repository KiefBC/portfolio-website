	...
	<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
			{#each displayedProjects as project}
				<div class="bg-slate-800 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-4 hover:rotate-1 hover:scale-105 group perspective-1000 preserve-3d project-card">
					<div class="p-6">
						...
						<p class="text-slate-300 mb-4 leading-relaxed project-description">
							{project.description}
						</p>
