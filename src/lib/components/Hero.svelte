...
<section id="home" class="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
	<div class="text-center px-4 sm:px-6 lg:px-8">
		<div class="mb-8">
			<h1 class="text-5xl md:text-7xl font-bold text-white mb-4 animate-fade-in">
				Hi, I'm <span class="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">Kiefer</span>
			</h1>
			<div class="text-2xl md:text-3xl text-slate-300 mb-8 h-12 animate-fade-in-delay-200">
				I'm a <span class="text-purple-400 font-semibold">{typedText}<span class="animate-pulse">|</span></span>
			</div>
			<p class="text-xl text-slate-400 mb-12 max-w-2xl mx-auto leading-relaxed animate-fade-in-delay-400">
		...
		<div class="mt-12 flex justify-center space-x-6 animate-fade-in-delay-800">
			<a href="https://github.com/KiefBC" target="_blank" class="text-slate-400 hover:text-white transition-colors duration-200" aria-label="GitHub Profile">
			...
			<a href="https://www.linkedin.com/in/kieferh/" target="_blank" class="text-slate-400 hover:text-white transition-colors duration-200" aria-label="LinkedIn Profile">
				<svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
